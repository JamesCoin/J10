...
// Copyright (c) 2013-2014 JamesCoin developers
...
static const unsigned int MAX_TX_COMMENT_LEN_V2 = 140;
static const unsigned int TX_COMMENT_V2_HEIGHT = 1000000000;
