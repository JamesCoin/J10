...
uint256 hashGenesisBlock("0x4f3692020269a4dfacf6f603bad4b4c8b16dd099a4e117c659e41a8f68a52844");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // JamesCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "JamesCoin Signed Message:\n";
...
static const int64 nInterval_Version1 = nTargetTimespan_Version1;

static const int64 nHeight_Version2 = 10000000000;
...
static const int64 nHeight_Version3 = 20000000000;
...
static const int64 nMaxAdjustDown_Version1 = 50; 
static const int64 nMaxAdjustUp_Version1 = 50; 
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal jamescoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JamesCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "nec deus intersit, nisi dignus uindice nodus inciderit; nec quarta loqui persona laboret - DEUS EX MACHINA";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
		...
		txNew.strTxComment = "text:JamesCoin genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 11407008856;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3046544;

        if (fTestNet)
        {
            block.nTime    = 1407008855;
            block.nNonce   = 0;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6403925e6998932c306f27e3b46cf046471abb277ad732457ea571e31ea57e23"));
...
//   0xa5, 0xf1 = unique id
unsigned char pchMessageStart[4] = { 0xfd, 0xfd, 0xdf, 0xc0 };
